...
it('cannot display trashed records by default', function (): void {
    $records = Note::factory()->count(4)->create();
    $trashedRecords = Note::factory()->trashed()->count(6)->create();
...
it('can paginate records', function (): void {
    $records = Note::factory(20)->create();
