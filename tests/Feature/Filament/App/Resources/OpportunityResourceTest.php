...
it('can render the view page', function (): void {
    $record = Opportunity::factory()->create();
...
it('can sort `:dataset` column', function (string $column): void {
    $records = Opportunity::factory(3)->create();
...
it('cannot display trashed records by default', function (): void {
    $records = Opportunity::factory()->count(4)->create();
    $trashedRecords = Opportunity::factory()->trashed()->count(6)->create();
...
it('can paginate records', function (): void {
    $records = Opportunity::factory(20)->create();
...
it('can bulk delete records', function (): void {
    $records = Opportunity::factory(5)->create();
