...
it('cannot display trashed records by default', function (): void {
    $records = Task::factory()->count(4)->create();
    $trashedRecords = Task::factory()->trashed()->count(6)->create();
...
it('can paginate records', function (): void {
    $records = Task::factory(20)->create();
